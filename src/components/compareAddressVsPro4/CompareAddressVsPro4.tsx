...
import { CONTAINER_STYLE, getAnimalData, MAP_CENTER, MAP_STYLE } from '../const/const'
import { Map } from 'react-kakao-maps-sdk'
import { useQuery } from '@tanstack/react-query'
import proj4 from 'proj4'
const MAP_CONTAINER_STYLE: CSSProperties = { display: 'flex', flexDirection: 'column', alignItems: 'center' }
      ...
      <div style={{ display: 'flex', gap: '40px' }}>
        {isPro4Loading ? (
          ...
          <div style={MAP_CONTAINER_STYLE}>
            ...
            <Map center={MAP_CENTER} style={MAP_STYLE} onCreate={handlePro4KakaoMap}></Map>
          </div>
        )}
